...
if(isset($_POST['submit']))
{
	...
	$query=mysqli_query($con,"insert into users(name,email,contactno,password,address,profilepic) values('$name','$email','$contactno','$password','$address','$profilepic')");
	if($query)
	{
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<p class="text title-tag-line">Create your Shopping account.</p>
	<form class="register-form outer-top-xs" role="form" method="post" name="register" onSubmit="return valid();">
		...
		<div class="form-group">
	    	<label class="info-title" for="profilepic">Profile Picture. <span>*</span></label>
	    	<input type="file" class="form-control unicase-form-control text-input" id="profilepic" name="profilepic" required >
	  	</div>
