...
{	
	header('location:index.php');
		...
		if(isset($_POST['submit']))
		{
			...
			$sql=mysqli_query($con,"update  products set category='$category',subCategory='$subcat',productName='$productname',productSku='$productsku',productPrice='$productprice',productDescription='$productdescription',shippingCharge='$productscharge',productAvailability='$productavailability' where id='$pid' ");
...
while($rw=mysqli_fetch_array($query))
{
	...
	?>
									...
									<div class="control-group">
										<label class="control-label" for="basicinput">Product SKU Number</label>
									<div class="controls">
										<input type="text"    name="productSku"  placeholder="Enter Product SKU Number" value="<?php echo htmlentities($row['productSku']);?>" class="span8 tip" required>
									</div>
									</div>
