...
{	
	header('location:index.php');
		...
		if(isset($_POST['submit']))
		{
			...
			$sql=mysqli_query($con,"insert into products(category,subCategory,productName,productSku,productPrice,productDescription,shippingCharge,productAvailability,productImage1,productImage2,productImage3) values('$category','$subcat','$productname','$productsku','$productprice','$productdescription','$productscharge','$productavailability','$productimage1','$productimage2','$productimage3')");
...
<?php } ?>
									...
									<div class="controls">
										<input type="text"    name="productSku"  placeholder="Enter Product SKU Number" class="span8 tip" required>
									</div>
									</div>
